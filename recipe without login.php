...
<?php
include('connection.php');
$sql = 'SELECT recipe_name, recipe, image, chef FROM post';
$result = $c->query($sql);
...
<div class='container p-3 my-3'  id= 'top-recipes-home'>
    ...
    <div style=><p id='123' style='flex: row; '>
      <h5 style='font-weight: bolder; text-align: center;'>".$recipe_name."</h5> <br> <p style='padding-left: 25px; padding-right: 20px;'>" .$recipe."    
