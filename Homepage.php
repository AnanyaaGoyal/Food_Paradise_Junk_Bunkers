...
<div class="container">
            <nav class="navbar navbar-expand-lg navbar-fixed-top">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item" style="margin-left:15px;">
                      <a class="nav-link" href="recipe without login.php">Recipes</a>
                      </li>
                   <li class="nav-item" style="margin-left:15px;">
                ...
                <ul class="navbar-nav navbar-right">
                   <li class="nav-item" style="margin-left:15px;">
                    <a class="nav-link" href="sign up form.php"> Sign Up <span class="glyphicon glyphicon-user"></span></a>
                  </li>
                  
                  <li class="nav-item" style="margin-left:15px; margin-right:15px;">
                    <a class="nav-link" href="login form.php"> Login  <span class="glyphicon glyphicon-log-in"></span> </a>
                  </li>
                  </ul>
...
<div class="container">
  <div class="card" style="width:300px" id="rise">
    ...
    <div class="card-body">
      ...
      <h4 class="card-title" style="color:#96c0b7;">CHOCO-FLOW</h4>
    </div>
...
<div class="container">
  <div class="card" style="width:300px" id="rise">
    ...
    <div class="card-body">
      ...
      <h4 class="card-title" style="color:#96c0b7;">KALE</h4>
    </div>
   </div>
</div>
...
<div class="container">
  <div class="card" style="width:300px" id="rise">
    ...
    <div class="card-body">
      ...
      <h4 class="card-title" style="color:#96c0b7;">MANGO</h4>
    </div>
  </div>
</div>
</div>
