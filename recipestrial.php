            ...
            <nav class='navbar navbar-expand-lg navbar-fixed-top'>
                ...
                <div class='collapse navbar-collapse' id='navbarSupportedContent'>
                  <ul class='navbar-nav mr-auto'>
                   ...
                   <li class='nav-item' style='margin-left:15px;'>
                  <a class='nav-link' href='create_community.html'>Create a Community</a>
                  </li>
                </ul>
                <ul class='navbar-nav navbar-right'>
                  ...
                  <li class='nav-item' style='margin-left:15px; margin-right:15px;'>
                    <a class='nav-link' href='homepage.html'> Logout <span class='glyphicon glyphicon-log-out'></span> </a>
                  </li>
                  </ul>
...
<div class='container p-3 my-3'  id= 'top-recipes-home'>
    ...
    <div style=><p id='123' style='flex: row; '>
      <h5 style='font-weight: bolder; text-align: center;'>".$recipe_name."</h5> <br> <p style='padding-left: 25px; padding-right: 20px;'> <?php echo $recipe; ?>
